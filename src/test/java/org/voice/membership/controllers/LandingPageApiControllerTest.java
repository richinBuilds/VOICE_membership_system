...
// @Test
// void
// getLandingPageData_WithAuthenticatedUser_ShouldReturnDataWithLoggedInTrue()
// throws Exception {
// // Arrange
...
// @Test
// void
// getLandingPageData_WithUnauthenticatedUser_ShouldReturnDataWithLoggedInFalse()
// throws Exception {
// // Arrange
// when(landingPageService.getTagline()).thenReturn("Welcome to VOICE");
// when(landingPageService.getActiveMemberships()).thenReturn(mockMemberships);
...
// @Test
// void getLandingPageData_WithAdminUser_ShouldReturnDataWithLoggedInTrue()
// throws Exception {
// // Arrange
// when(landingPageService.getTagline()).thenReturn("Welcome to VOICE");
// when(landingPageService.getActiveMemberships()).thenReturn(mockMemberships);
...
// @Test
// void getLandingPageData_WithEmptyMemberships_ShouldReturnEmptyArray() throws
// Exception {
// // Arrange
// when(landingPageService.getTagline()).thenReturn("Welcome to VOICE");
...
// @Test
// void getLandingPageData_WithEmptyBenefits_ShouldReturnEmptyArray() throws
// Exception {
// // Arrange
// when(landingPageService.getTagline()).thenReturn("Welcome to VOICE");
// when(landingPageService.getActiveMemberships()).thenReturn(mockMemberships);
...
// @Test
// void getLandingPageData_WithNullTagline_ShouldReturnNullTagline() throws
// Exception {
// // Arrange
...
// @Test
// void initialize_WithSuccessfulInitialization_ShouldReturnSuccess() throws
// Exception {
// // Arrange
...
// .andExpect(jsonPath("$.message").value("Default landing page content
...
// @Test
// void initialize_WithContentInitializationError_ShouldReturnError() throws
// Exception {
// // Arrange
...
// @Test
// void initialize_WithMembershipInitializationError_ShouldReturnError() throws
// Exception {
// // Arrange
// doNothing().when(landingPageService).initializeDefaultContent();
...
// @Test
// void initialize_WithBenefitInitializationError_ShouldReturnError() throws
// Exception {
// // Arrange
// doNothing().when(landingPageService).initializeDefaultContent();
// doNothing().when(landingPageService).initializeDefaultMemberships();
...
// @Test
// void initialize_WithIllegalStateException_ShouldReturnError() throws
// Exception {
// // Arrange
// doNothing().when(landingPageService).initializeDefaultContent();
