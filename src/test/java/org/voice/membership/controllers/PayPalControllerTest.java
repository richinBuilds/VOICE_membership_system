...
class PayPalControllerTest {
    ...
    void captureOrder_WithFailedValidation_ShouldReturnBadRequest() throws Exception {
        ...
        PayPalService.CaptureValidationResult validationResult = new PayPalService.CaptureValidationResult(false, null,
    ...
    void webhook_WithValidPaymentCaptureCompleted_ShouldProcessUpgrade() throws Exception {
        ...
        when(payPalService.validateOrderFromPayPal(any(User.class), any(Membership.class), eq("WEBHOOK-ORDER-123")))
                .thenReturn(validationResult);
    ...
    void webhook_WithValidationFailure_ShouldReturnValidationFailed() throws Exception {
        ...
        when(payPalService.validateOrderFromPayPal(any(User.class), any(Membership.class), eq("VALIDATION-FAIL-ORDER")))
                .thenReturn(validationResult);
    ...
    void captureOrder_CalledTwiceForSameOrder_ShouldBeIdempotent() throws Exception {
        ...
        when(payPalService.captureAndValidateOrder(any(User.class), any(Membership.class), eq("ORDER-IDEM-123")))
    ...
    void webhook_ReceivedTwiceForSameEvent_ShouldBeIdempotent() throws Exception {
        ...
        when(payPalService.validateOrderFromPayPal(any(User.class), any(Membership.class), eq("ORDER-WEBHOOK-IDEM")))
        ...
        // Verify only ONE completed transaction
    ...
    void captureOrder_WithZeroAmountForPaidMembership_ShouldReject() throws Exception {
        ...
        // Mock validation showing zero amount
        PayPalService.CaptureValidationResult invalidResult = new PayPalService.CaptureValidationResult(false, null,
    ...
    void captureOrder_AfterUserDeleted_ShouldHandleGracefully() throws Exception {
        ...
        PayPalService.CaptureValidationResult result = new PayPalService.CaptureValidationResult(true, "COMPLETED",
                "Success", "CAPTURE-DEL");
        when(payPalService.captureAndValidateOrder(any(User.class), any(Membership.class), eq("ORDER-DELETED-USER")))
                .thenReturn(result);
        ...
        mockMvc.perform(post("/register/paypal/capture-order")
                ...
                .with(user(userEmail).roles("USER"))
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"orderId\": \"ORDER-DELETED-USER\", \"membershipId\": " + paidMembership.getId() + "}"))
    ...
    void captureOrder_WithNegativeAmount_ShouldReject() throws Exception {
        ...
        when(payPalService.captureAndValidateOrder(any(User.class), any(Membership.class), eq("ORDER-NEGATIVE")))
                .thenReturn(invalidResult);
